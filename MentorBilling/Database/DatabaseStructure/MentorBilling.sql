...
CREATE TABLE invoice.factura (
  ...
  furnizor_id bigint NOT NULL DEFAULT 0 REFERENCES seller.furnizori(id)  ON UPDATE CASCADE ON DELETE CASCADE,
  cumparator_id bigint NOT NULL DEFAULT 0 REFERENCES buyer.cumparatori(id) ON UPDATE CASCADE ON DELETE CASCADE,
  utilizator_id bigint NOT NULL DEFAULT 0 REFERENCES users.utilizatori(id) ON UPDATE CASCADE ON DELETE CASCADE,
  creator_id bigint NOT NULL DEFAULT 0 REFERENCES users.utilizatori(id) ON UPDATE CASCADE ON DELETE CASCADE,
