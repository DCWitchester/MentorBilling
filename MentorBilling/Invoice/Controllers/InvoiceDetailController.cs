...
{
    public class InvoiceDetailController : InvoiceDetails
    {
        ...
        public InvoiceDetailController(InstanceSettings settings)
        {
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        /// </summary>
        public Double TotalValue => Math.Round(totalValue, instanceSettings.RoundAT, instanceSettings.MidpointRounding);
        /// <summary>
        /// the display element for the total VAT Value
        /// </summary>
        public Double TotalVATValue => Math.Round(totalVATValue, instanceSettings.RoundAT, instanceSettings.MidpointRounding);
        #endregion
