...
namespace MentorBilling.Settings
{
    ...
    public class InstanceSettings : ProgramSettings
    {
        ...
        /// <summary>
        /// the default value of the rounding point for the display 
        /// </summary>
        public SpecialSettingsEnums.RoundingMode RoundingMode
        {
            get => base.roundingMode;
            set => base.roundingMode = value;
        }

        /// <summary>
        /// the default value of the rounding point for the 
        /// </summary>
        public MidpointRounding MidpointRounding => base.roundingMode switch
        {
            SpecialSettingsEnums.RoundingMode.Default => MidpointRounding.ToEven,
            SpecialSettingsEnums.RoundingMode.RoundDown => MidpointRounding.ToNegativeInfinity,
            SpecialSettingsEnums.RoundingMode.RoundUp => MidpointRounding.ToPositiveInfinity,
            ...
            foreach (Setting setting in settings)
            {
                ...
                switch (setting.ID)
                {
                    ...
                    case (Int32)SpecialSettingsEnums.DatabaseSettingsLink.RoundAt:
                        ...
                        break;
                    case (Int32)SpecialSettingsEnums.DatabaseSettingsLink.RoundingMode:
                        this.RoundingMode = (SpecialSettingsEnums.RoundingMode)setting.GetIntegerValue;
                        break;
                }
            }
        }
